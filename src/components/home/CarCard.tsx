...
import { getMakeLogo } from '@/constants/makes';
    ...
    <Link href={`/cars/${car.id}`} className="block">
      <div className={`bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:scale-[1.02] ${
        ...
        <div className="relative h-48">
          ...
          <div className="absolute top-4 right-4 w-8 h-8 rounded-full overflow-hidden bg-white shadow-lg">
            <Image
              src={car.make_logo_url || getMakeLogo(car.make)}
              alt={car.make}
              fill
              sizes="32px"
